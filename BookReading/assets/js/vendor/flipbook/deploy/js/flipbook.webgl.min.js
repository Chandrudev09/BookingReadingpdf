...
(FLIPBOOK.PageWebGL = function (t, e, i, o, s, n) {
  THREE.Object3D.call(this),
    ...
    (this.index = e),
    (this.pW = o.pageWidth),
    (this.pH = o.pageHeight),
    (this.nfacesw = o.pageSegmentsW),
    (this.nfacesh = o.pageSegmentsH),
    (this.mats = []),
    (this.pageHardness = i),
    (this.pageThickness = i),
    (this.duration = o.pageFlipDuration),
    (this.angle = (0.25 * Math.PI * this.pW) / this.pH),
    (this.force = 10),
    (this.offset = 0),
    (this.to = null),
    (this.mod = null),
    ...
    (this.options = o);
  var r = o.rightToLeft ? o.pages.length / 2 - this.index - 1 : this.index;
  (this.indexF = o.rightToLeft ? 2 * r + 1 : 2 * r),
    (this.indexB = o.rightToLeft ? 2 * r : 2 * r + 1),
    (this.showing = !1),
    (this.preloaderMatF = s),
    (this.preloaderMatB = n);
  var h = this;
  0 == e &&
    this.options.cornerCurl &&
    ((this.nfacesw = 20),
    (this.nfacesh = 20),
    (this.cornerCurlTween = new FLIPBOOK.TWEEN.Tween(0)
      .to(1, 1e3)
  ...
  var a = new THREE.MeshBasicMaterial({ color: 15592941 }),
    p = [a, a, a, a, s, n],
    c = [a, a, a, a, a, a];
  if (this.options.pagePreloader) c = [a, a, a, a, s, n];
  (this.cube = new THREE.Mesh(this.gF, p)),
    (this.cube.position.x = 0.5 * this.pW),
    this.options.shadows &&
      ((this.cube.castShadow = !0), (this.cube.receiveShadow = !0)),
    ...
    (this.cubeEmpty.position.x = 0.5 * this.pW),
  ...
  (FLIPBOOK.PageWebGL.prototype.onPageCanvasLoaded = function (t, e, i) {
    if ("front" == e && this.sizeFront != t.size) {
      ...
      (s.minFilter = THREE.LinearFilter),
        ...
        (s.repeat.x = o.scaleX),
        (s.repeat.y = o.scaleY),
        (s.offset.y = 1 - o.scaleY),
        o.double && (s.offset.x = 0.5),
        (this.frontMaterial = this.createMaterial(s, "front")),
        (this.frontMaterial.needsUpdate = !0),
      ...
      (n.minFilter = THREE.LinearFilter),
        ...
        (n.repeat.x = o.scaleX),
        (n.repeat.y = o.scaleY),
        (n.offset.y = 1 - o.scaleY),
        (this.backMaterial = this.createMaterial(n, "back")),
        (this.backMaterial.needsUpdate = !0),
  ...
  (FLIPBOOK.PageWebGL.prototype.loadHTML = function (t, e) {
    ...
    this.htmlLoaded
      ? e.call(this)
      : this.options.main.loadPageHTML(i, function (t) {
          e.call(o);
        });
  }),
  (FLIPBOOK.PageWebGL.prototype.load = function (t, e) {
    var i = this.book.model;
    if (i.wrapperH && i.zoom) {
      for (
        var o = this.book.pages, s = this, n = this.book.options, r = 0;
        r < o.length;
        r++
      ) {
        var h = o[r];
      ...
      var a = n,
        p =
          i.wrapperH * i.zoom < 0.8 * a.pageTextureSizeSmall
            ? a.pageTextureSizeSmall
            : a.pageTextureSize;
      "front" == t
        ? this.sizeFront == p
          ? e && e.call(this)
          : this.options.main.loadPage(this.indexF, p, function (t) {
              if (t) {
                if (t.canvas) s.onPageCanvasLoaded(t, "front", e);
                else if (t.image) {
                  if (s.loadedFront) return void e.call(s);
                  s.loadedFront = !0;
                  var i = new THREE.Texture();
                  (i.image = t.image),
                    (i.minFilter = THREE.LinearFilter),
                    (i.needsUpdate = !0),
                    "left" == s.options.pages[2 * s.index].side
                      ? (i.repeat.x = 0.5)
                      : "right" == s.options.pages[2 * s.index].side &&
        ...
        : "back" == t &&
          (this.sizeBack == p
            ? e && e.call(this)
            : this.options.main.loadPage(this.indexB, p, function (t) {
                if (t) {
                  if (t.canvas) s.onPageCanvasLoaded(t, "back", e);
                  else if (t.image) {
                    if (s.loadedBack) return void e.call(s);
                    s.loadedBack = !0;
                    var i = new THREE.Texture();
                    (i.image = t.image),
                      (i.minFilter = THREE.LinearFilter),
                      (i.needsUpdate = !0),
                      "left" == s.options.pages[2 * s.index + 1].side
                        ? (i.repeat.x = 0.5)
                        : "right" == s.options.pages[2 * s.index + 1].side &&
                          ((i.repeat.x = 0.5), (i.offset.x = 0.5)),
  ...
  (FLIPBOOK.PageWebGL.prototype.createMaterial = function (t, e) {
    ...
    } else i = new THREE.MeshBasicMaterial({ map: t });
    return i;
  }),
    ...
    if (t <= 180 && t >= -180) {
      if (
        ...
        this.singlePage &&
          ...
          t < 0 && (t -= 90),
          t < -180 && (t = -180),
          this.index == this.book.pages.length - 1))
      )
        return;
      t < 0 && (t += Math.PI),
        (this.angle = t),
        ...
        this.isFlippedLeft
          ? (this.bendF.force =
              (1.35 * Math.pow(-Math.abs(Math.cos(-t / 2)), 1)) /
              Math.pow(this.pageHardness, 1.5))
          : (this.bendF.force =
              (1.35 * Math.pow(Math.abs(Math.sin(-t / 2)), 1)) /
              Math.pow(this.pageHardness, 1.5)),
        this.updateBend(),
        this.book.htmlLayerVisible &&
  ...
  (FLIPBOOK.PageWebGL.prototype.flipLeft = function (t) {
    if (
      ...
      if (this.duration > 0) {
        ...
        var e = (1 + 0.5 * Math.random()) / this.pageHardness,
          i = 0.1 + 0.2 * Math.random();
        (this.to = {
  ...
  (FLIPBOOK.PageWebGL.prototype.correctZOrder = function () {
    var t;
    for (this.position.z = 3, t = this.index - 1; t >= 0; t--)
      this.book.pages[t].position.z =
        this.book.pages[t + 1].position.z - 2 - 2 - 1;
    for (t = this.index + 1; t < this.book.pages.length; t++)
      this.book.pages[t].position.z =
        this.book.pages[t - 1].position.z - 2 - 2 - 1;
  }),
  (FLIPBOOK.PageWebGL.prototype.flipLeftInstant = function (t) {
    if (
      ...
      (this.thiss = this),
        ...
        (this.isFlippedRight = !1);
      this.position.z = 3;
      for (var e = this.index + 1; e < this.book.pages.length; e++)
        this.book.pages[e].position.z =
          this.book.pages[e - 1].position.z - 2 - 2 - 1;
      if (this.index < this.book.pages.length - 1) {
        ...
        this.index > 0 &&
          (this.book.pages[this.index].position.z =
            this.book.pages[this.index - 1].position.z + 2 + 2 - 1);
      this.flipFinished();
    }
  }),
  (FLIPBOOK.PageWebGL.prototype.hideMat = function () {
    this.showing &&
      (this.remove(this.cube), this.add(this.cubeEmpty), (this.showing = !1));
  }),
  ...
  (FLIPBOOK.PageWebGL.prototype.setFrontMat = function (t) {
    this.cube.material[4] !== t &&
      ((this.cube.material[4] = t), (this.book.needsUpdate = !0));
  }),
  (FLIPBOOK.PageWebGL.prototype.setBackMat = function (t) {
    this.cube.material[5] !== t &&
      ((this.cube.material[5] = t), (this.book.needsUpdate = !0));
  }),
  (FLIPBOOK.PageWebGL.prototype.flipRightInstant = function (t) {
    if (
      ...
      (this.thiss = this),
        ...
        (this.isFlippedRight = !0);
      this.position.z = 3;
      for (var e = this.index - 1; e >= 0; e--)
        this.book.pages[e].position.z =
          this.book.pages[e + 1].position.z - 2 - 2 - 1;
      if (this.index > 0) {
        this.position.z = this.book.pages[this.index - 1].position.z;
        for (e = this.index + 1; e < this.book.pages.length; e++)
          this.book.pages[e].position.z =
            this.book.pages[e - 1].position.z - 2 - 2 - 1;
      } else
        this.book.pages.length > 1 &&
          (this.position.z =
            this.book.pages[this.index + 1].position.z + 2 + 2 - 1);
      this.flipFinished();
    }
  ...
  (FLIPBOOK.PageWebGL.prototype.bendIn = function (t, e, i) {
    ...
    var o =
      ...
      this.duration *
      240 *
      Math.pow(Math.abs(this.rotation.y - t) / Math.PI, 0.5) *
      Math.pow(this.pageHardness, 0.25);
    new FLIPBOOK.TWEEN.Tween(this.to)
      .to({ angle: t, xx: 1, t: 1 }, o)
  ...
  (FLIPBOOK.PageWebGL.prototype.bendOut = function () {
    var t = this.thiss,
      e = t.duration * Math.pow(Math.abs(t.bendF.force), 0.5) * 1e3;
    new FLIPBOOK.TWEEN.Tween(t.bendF)
      .to({ force: 0, offset: 1 }, e)
      .easing(FLIPBOOK.TWEEN.Easing.Sinusoidal.Out)
      .onUpdate(function () {
        t.updateBend();
      })
    ...
    if (t.flippingLeft)
      if (t.index < t.book.pages.length - 1) {
        ...
        for (var i = t.index - 1; i >= 0; i--)
          t.book.pages[i].position.z =
            t.book.pages[i + 1].position.z - 2 - 2 - 1;
      } else
        t.book.pages.length > 1 &&
          (t.book.pages[t.index].position.z =
            t.book.pages[t.index - 1].position.z + 2 + 2 - 1);
    if (t.flippingRight)
      if (t.index > 0) {
        t.position.z = t.book.pages[t.index - 1].position.z;
        for (i = t.index + 1; i < t.book.pages.length; i++)
          t.book.pages[i].position.z =
            t.book.pages[i - 1].position.z - 2 - 2 - 1;
      } else
        t.book.pages.length > 1 &&
          (t.position.z = t.book.pages[t.index + 1].position.z + 2 + 2 - 1);
  }),
  ...
  (FLIPBOOK.BookWebGL.prototype.init3d = function () {
    var t = this,
      e = jQuery(t.wrapper).width() / jQuery(t.wrapper).height(),
      i = this.options;
    ...
    (window.renderer = s),
      ...
      (s.gammaOutput = !0),
      this.options.shadows &&
        ((s.shadowMap.enabled = !0), (s.shadowMap.type = THREE.PCFShadowMap)),
      (window.webglrenderer = this.renderer = s),
      this.renderer.setSize(o.clientWidth, o.clientHeight);
    var n =
      window.devicePixelRatio < i.minPixelRatio
        ? i.minPixelRatio
        : window.devicePixelRatio;
    this.renderer.setPixelRatio(n), o.appendChild(this.renderer.domElement);
    for (var r = !1, h = this.options.pages, a = 0; a < h.length; a++)
      h[a].htmlContent && (r = !0);
    if (
      ((this.options.hasHtmlContent = r || i.pdfMode),
      this.options.hasHtmlContent && this.initHtmlContent(),
      ...
      if (
        ((c.intensity = i.lightIntensity),
        c.position.set(i.lightPositionX, i.lightPositionY, i.lightPositionZ),
        (c.distance = 4e3),
        this.options.shadows)
      ) {
        (c.castShadow = !0),
          (c.shadow.bias = -2e-6),
          (c.shadow.mapSize.x = this.options.shadowMapSize),
          (c.shadow.mapSize.y = this.options.shadowMapSize);
        ...
        d.position.set(0, 0, -i.shadowDistance),
          this.Scene.add(d),
          (d.receiveShadow = !0);
      }
      this.Scene.add(c);
    ...
    this.centerContainer.position.set(0, 0, 0),
      this.onResize(),
      (this.centerContainer.position.x =
        0.5 * -this.pageW * this.centerContainer.scale.x),
      ...
      (this.cameraZMax = 5e3),
      (function e() {
        if ((FLIPBOOK.TWEEN.update(), t.rendering)) {
          if (!t.enabled) return;
          t.needsUpdate &&
  ...
  (FLIPBOOK.BookWebGL.prototype.onPageUnloaded = function (t, e) {
    ...
    this.options.rightToLeft
      ? ((o = this.pages.length - o - 1), (i = t % 2 == 0 ? "back" : "front"))
      : (i = t % 2 == 0 ? "front" : "back"),
      this.pages[o].unload(i);
  }),
  (FLIPBOOK.BookWebGL.prototype.initHtmlContent = function () {
    ...
    (this.$htmlLayer = e),
      ...
      (this.$pageC = jQuery(document.createElement("div"))
        ...
        .css({
          width:
            (2e3 * this.options.pageWidth) / this.options.pageHeight + "px",
          height: "1000px",
          position: "absolute",
          top: "-500px",
          left:
  ...
  (FLIPBOOK.BookWebGL.prototype.onSwipe = function (t, e, i, o, s, n, r) {
    if (!this.isZoomed()) {
      ...
      if (
        ...
        (a && a.dragging) ||
        (h && h.dragging) ||
        ("rotate" != this.onMouseMove && "scroll" != this.onMouseMove)
      ) {
        if (("cancel" == e || "end" == e) && n <= 1) {
          if (1 == this.view && this.draggingBook && "left" == i)
            return this.nextPage(), void (this.draggingBook = !1);
          if (1 == this.view && this.draggingBook && "right" == i)
            return this.prevPage(), void (this.draggingBook = !1);
          !(o < 0) || (a && a.dragging)
            ? !(o > 0) || (h && h.dragging)
              ? 0 == o &&
                this.clickedPage &&
                (this.clickedPage.isFlippedLeft
                  ? this.prevPage()
                  : this.nextPage())
              : this.nextPage()
            : this.prevPage(),
        ...
        if ("move" == e && n <= 1) {
          if (this.draggingBook)
            return (
              (this.centerContainer.position.x = this.draggingBookStartX - o),
          ...
          if (1 == this.view && this.isFocusedRight() && "right" == i)
            return (
              (this.draggingBookStartX = this.centerContainer.position.x),
              void (this.draggingBook = !0)
            );
          if (
            ((o = (180 * o) / this.wrapperW),
            (h && h.flipping) || (a && a.flipping))
          )
            return;
          (a && a.dragging) || (h && h.dragging)
            ? (h && !a) || (h && !a.dragging)
              ? o <= 0 && h._setAngle(o, i)
              : ((a && !h) || (a && !h.dragging)) && o >= 0 && a._setAngle(o, i)
            : 0 != o &&
              ("right" != i || !h || (a && a.dragging) || !this.prevEnabled
                ? "left" == i &&
                  a &&
                  this.nextEnabled &&
                  (a._setAngle(o, i), a.positionZ(200), p && p.showMat())
                : (h._setAngle(o, i), h.positionZ(200), c && c.showMat()));
        }
      }
    }
  }),
  (FLIPBOOK.BookWebGL.prototype.onResize = function () {
    ...
    if (i < 1e3 && 1 == window.devicePixelRatio) this.renderer.setPixelRatio(2);
      ...
      var r =
        window.devicePixelRatio < o.minPixelRatio
          ? o.minPixelRatio
          : window.devicePixelRatio;
    ...
    var h = Math.min(this.zoom, 1),
      a = Number(o.zoomMin);
    o.responsiveView && e <= o.responsiveViewTreshold && s < 2 * n
      ? ((this.view = 1),
        (this.sc = n > s ? (a * s) / (n * h) : 1),
        0 == this.rightIndex || this.isFocusedRight()
          ? this.focusRight()
          : this.focusLeft())
      : ((this.view = 2),
        (this.sc = s < 2 * n ? (a * s) / (2 * n * h) : 1),
        0 == this.flippedleft
          ? this.focusRight()
          : 0 == this.flippedright
          ? this.focusLeft()
  ...
  (FLIPBOOK.BookWebGL.prototype.updateCameraPosition = function () {
    ...
    this.centerContainer.scale.set(this.sc, this.sc, this.sc),
      ...
      (o = Math.cos(e) * o),
      (this.cameraZ = o),
      this.Camera.position.set(Math.round(t), Math.round(i), Math.round(o)),
  ...
  (FLIPBOOK.BookWebGL.prototype.createPages = function () {
    var t,
      ...
      i,
      o = this.options,
      s = o.pageMiddleShadowSize,
      n = document.createElement("canvas");
    (n.width = 64), (n.height = 64);
    var r = n.getContext("2d"),
      h = r.createLinearGradient(64 - s, 0, 64, 0);
    h.addColorStop(0, "#AAAAAA"),
      h.addColorStop(1, o.pageMiddleShadowColorL),
      (r.fillStyle = h),
      r.fillRect(0, 0, 64, 64);
    var a = new THREE.CanvasTexture(n);
    (a.needsUpdate = !0), (this.specularB = a);
    var p = document.createElement("canvas");
    (p.width = 64), (p.height = 64);
    var c = p.getContext("2d"),
      l = c.createLinearGradient(0, 0, s, 0);
    l.addColorStop(0, o.pageMiddleShadowColorR),
      l.addColorStop(1, "#AAAAAA"),
      (c.fillStyle = l),
      c.fillRect(0, 0, 64, 64);
    var d,
      u,
      f = new THREE.CanvasTexture(p);
    if (
      ((f.needsUpdate = !0), (this.specularF = f), this.options.pagePreloader)
    ) {
      var g = new THREE.TextureLoader().load(
        this.options.pagePreloader,
        function () {}
      );
      this.options.lights
        ? ((d = new THREE.MeshStandardMaterial({
            map: g,
            roughness: this.options.pageRoughness,
            metalness: this.options.pageMetalness,
            emissive: 0,
            color: 15592941,
            lightMap: this.specularF,
          })),
          (u = new THREE.MeshStandardMaterial({
            ...
            emissive: 0,
            color: 15592941,
            lightMap: this.specularB,
          })))
        : (d = u = new THREE.MeshBasicMaterial({ map: g, color: 15592941 }));
    } else
      this.options.lights
        ? ((d = new THREE.MeshStandardMaterial({
            roughness: this.options.pageRoughness,
        ...
        : (d = u = new THREE.MeshBasicMaterial({ color: 15592941 }));
    var m = this.options.pages;
    for (i = 0; i < m.length / 2; i++) {
      (t =
        0 == i || i == m.length / 2 - 1
          ? this.options.coverHardness
          : this.options.pageHardness),
        (e = new FLIPBOOK.PageWebGL(this, i, t, this.options, d, u)),
        this.pages.push(e),
        this.centerContainer.add(e),
        this.flippedright++;
      i > 0
        ? ((e.position.z = this.pages[i - 1].position.z - 2 - 2 - 1),
          this.bg && (this.bg.position.z = e.position.z - 5))
        : (e.position.z = 2);
    }
    this.initialized = !0;
  }),
    ...
    if (this.initialized) {
      if (e)
        for (var o = 0; o < this.pages.length; o++)
          if (this.pages[o].flippingLeft || this.pages[o].flippingRight) return;
      if (
        (t < 0 && (t = 0),
        ...
        var s = e ? 0 : 300;
        t % 2 == 0 ? this.focusLeft(s) : this.focusRight(s);
      }
      if ((t % 2 != 0 && t--, t == this.rightIndex))
        return this.loadPages(), void this.turnPageComplete();
      this.goingToPage = !0;
      r = this;
      var n = (1e3 * this.options.pageFlipDuration) / 6;
      if (void 0 !== e && e) {
        if (t > r.rightIndex) for (; r.rightIndex < t; ) this.nextPageInstant();
        else for (; r.rightIndex > t; ) this.prevPageInstant();
        return (
          this.updateBookPosition(),
          this.loadPages(),
        ...
        ? ((n =
          ...
          this.rightIndex - 2 > t
            ...
            : (this.prevPage(),
              setTimeout(function () {
                if (void 0 !== e && e)
                  for (var t = 0; t < r.pages.length; t++)
                    r.pages[t].duration = r.options.pageFlipDuration;
                r.loadPages();
              }, n)))
        : this.rightIndex < t &&
          ((n =
    ...
    if (0 != this.flippedright) {
      ...
      if (1 == this.view) {
        if (this.isFocusedLeft()) {
          if (!this.goingToPage)
            return this.focusRight(0), void this.turnPageComplete();
          this.focusLeft(0, 0);
        }
      ...
      if (1 == this.view) {
        if (!this.goingToPage) {
          if (this.isFocusedRight())
            return this.focusLeft(0), void this.turnPageComplete();
          this.focusRight(0, 0);
        }
  ...
  (FLIPBOOK.BookWebGL.prototype.nextPage = function (t) {
    if (this.nextEnabled) {
      ...
      if (o) {
        ...
        var s = this.pages[o.index + 1];
        if (s || this.options.backCover || this.options.rightToLeft) {
          if ((s && i < 5 && s.showMat(), 1 == this.view)) {
            if (!this.goingToPage) {
              if (this.isFocusedLeft())
                return void this.focusRight(300, 0, this.turnPageComplete);
              this.focusLeft(600, 200);
            }
          } else
            1 == this.flippedright ? this.focusLeft(500) : this.focusBoth(500);
          if (!o.flipping) {
            var n,
              r = this;
            (void 0 === t || t) &&
              (n = function (t) {
                r.loadPages(), r.turnPageComplete();
              }),
              o.flipLeft(n);
          }
          this.flippedleft++,
  ...
  (FLIPBOOK.BookWebGL.prototype.updateBookPosition = function () {
    1 == this.view
      ...
      : 0 == this.rightIndex
      ? this.focusRight()
      : this.rightIndex >= this.options.numPages
      ? this.focusLeft()
      : this.focusBoth(),
      this.updateHtmlLayerPosition(),
      (this.needsUpdate = !0);
  ...
  (FLIPBOOK.BookWebGL.prototype.turnPageComplete = function () {
    (this.goingToPage = !1), this.options.main.turnPageComplete();
  }),
  (FLIPBOOK.BookWebGL.prototype.loadPages = function () {
    for (
      var t = this, e = this.pages, i = this.options.main, o = 0;
      o < e.length;
      o++
    ) {
      if ((a = e[o]).flippingLeft || a.flippingRight) return;
    }
    this.options.cornerCurl &&
      this.pages[0] &&
      (0 == this.flippedleft
    ...
    var s = this.pages[this.flippedleft],
      n = this.pages[this.flippedleft - 1],
      r =
        (this.pages[this.flippedleft - 2],
        this.pages[this.flippedleft + 1],
        this.pages[this.flippedleft - 3],
        this.pages[this.flippedleft + 2],
        this.updateHtmlLayer),
      h = this.loadMorePages;
    for (o = 0; o < e.length; o++) {
      var a;
      ((a = e[o]) !== s && a !== n) || a.showMat(),
        n &&
          a.index < n.index - 2 &&
          (a.hideMat(), this.options.pdfMode || a.disposeMat()),
        s &&
          a.index > s.index + 2 &&
          (a.hideMat(), this.options.pdfMode || a.disposeMat());
    }
    i.setLoadingProgress(0.1),
      n
        ? n.load("back", function (e) {
            s
              ? s.load("front", function (e) {
                  n.loadHTML("back", function () {
                    s.loadHTML("front", function () {
                      r.call(t);
                    });
                  }),
  ...
  (FLIPBOOK.BookWebGL.prototype.focusLeft = function (t, e, i) {
    ...
    var o = this.options.pageWidth,
      s =
        (this.wrapperW,
        this.wrapperH,
        this.zoom,
        0.5 * o * this.centerContainer.scale.x);
    this.moveToPos({ x: s, y: 0 }, t, e, i);
  }),
  ...
  (FLIPBOOK.BookWebGL.prototype.focusBoth = function (t, e, i) {
    this.options.pageHeight,
      ...
      this.wrapperH,
      this.zoom;
    this.moveToPos({ x: 0, y: 0 }, t, e, i);
  }),
  (FLIPBOOK.BookWebGL.prototype.moveToPos = function (t, e, i, o) {
    if (e && this.movingTo != t && this.centerContainer.position.x != t.x) {
      var s = this;
      (this.movingTo = t),
        this.bookMoveTween && this.bookMoveTween.stop(),
        (this.bookMoveTween = new FLIPBOOK.TWEEN.Tween(
          this.centerContainer.position
        )
          .to({ x: t.x, y: t.y }, e)
          .easing(FLIPBOOK.TWEEN.Easing.Sinusoidal.Out)
          .onUpdate(function () {
            s.updateHtmlLayerPosition();
          })
          .onComplete(function () {
            (s.movingTo = null), s.updateHtmlLayerPosition(), o && o.call(s);
          })
          .delay(i || 0)
          .start());
    } else
      ...
      if (o) {
        ...
        if (s || !this.options.rightToLeft || this.options.backCover) {
          ...
          if ((s && i < 5 && s.showMat(), 1 == this.view)) {
            if (!this.goingToPage) {
              if (this.isFocusedRight())
                return void this.focusLeft(300, 0, this.turnPageComplete);
              this.focusRight(600, 200);
            }
          } else
            1 == this.flippedleft ? this.focusRight(500) : this.focusBoth(500);
          if (!o.flipping) {
            var n,
              r = this;
            (void 0 === t || t) &&
  ...
  (FLIPBOOK.BookWebGL.prototype.loadMorePages = function () {
    for (
      var t = this.options.loadPagesF,
        e = this.options.loadPagesB,
        i = this.pages[this.flippedleft],
        o = this.pages[this.flippedleft - 1],
        s = 0;
      s < t;
      s++
    )
      (o = this.pages[this.flippedleft + s]) && o.load("back", function () {}),
        (i = this.pages[this.flippedleft + 1 + s]) &&
          i.load("front", function () {});
    for (s = 0; s < e; s++)
      (o = this.pages[this.flippedleft - 2 + s]) &&
        o.load("back", function () {}),
        (i = this.pages[this.flippedleft - 1 + s]) &&
          i.load("front", function () {});
  }),
  (FLIPBOOK.BookWebGL.prototype.updateHtmlLayer = function () {
    if (this.htmlLayer) {
      ...
      var e = this.options.rightToLeft
          ? this.options.pages.length - this.rightIndex - 1
          : this.rightIndex,
        ...
        if (0 == this.rightIndex) {
          ...
          if (
            ...
            (o =
              ...
              this.options.pages[e].htmlContent))
          ) {
  ...
  (FLIPBOOK.BookWebGL.prototype.zoomTo = function (t, e, i, o) {
    if (!this.zooming && this.pages.length) {
      void 0 === e && (e = 0);
      var s = this.centerContainer.position;
      if (void 0 !== i && void 0 !== o) {
        var n = (this.zoom * this.wrapper.clientHeight) / 1e3,
          ...
          a = {
            x: (i - this.wrapper.clientWidth / 2) / n - h.x,
            y: (-o + this.wrapper.clientHeight / 2) / n - h.y,
          },
          p = {
            x: (i - this.wrapper.clientWidth / 2) / r - h.x,
            y: (-o + this.wrapper.clientHeight / 2) / r - h.y,
          };
        ((s = h).x = h.x - (a.x - p.x)), (s.y = h.y - (a.y - p.y));
      }
      var c = this;
      this.options;
      if (
        ((newZoom = t > this.options.zoomMax ? this.options.zoomMax : t),
        (newZoom = t < this.options.zoomMin ? this.options.zoomMin : t),
        newZoom == this.options.zoom)
      ) {
        this.options;
        var l = this.isFocusedLeft();
        1 == this.view
          ? l
            ? this.focusLeft()
            : this.focusRight()
        ...
        ? this.zooming ||
          ...
          this.htmlLayer &&
            new FLIPBOOK.TWEEN.Tween(this.htmlLayer.position)
              ...
              .start())
        : ((this.zoom = newZoom),
          this.centerContainer.position.set(s.x, s.y, 0),
          c.updateHtmlLayerPosition(),
          this.updateCameraPosition(),
          (this.zooming = !1)),
  ...
  (FLIPBOOK.BookWebGL.prototype.tiltTo = function (t) {
    var e = this.tilt + 0.3 * t;
    (e =
      (e = e > this.options.tiltMax ? this.options.tiltMax : e) <
  ...
  (FLIPBOOK.BookWebGL.prototype.panTo = function (t) {
    var e = this.pan - 0.2 * t;
    (e =
      (e = e > this.options.panMax ? this.options.panMax : e) <
      this.options.panMin
        ? this.options.panMin
        : e),
      (this.pan = e),
  ...
  (FLIPBOOK.BookWebGL.prototype.handleEvent = function (t) {
    switch (t.type) {
      ...
      case "mousemove":
        ...
        break;
      case "mouseout":
        jQuery(this.wrapper).trigger("mouseup"), (this.mouseDown = !1);
        break;
      case "mouseup":
      case "touchend":
        this._end(t);
  ...
  (FLIPBOOK.BookWebGL.prototype._start = function (t) {
    ...
    var i = new THREE.Raycaster(
      ...
      e.sub(this.Camera.position).normalize()
    ).intersectObjects(this.pages, !0);
    (this.pageMouseDown = i.length > 0),
      "canvas" == t.target.nodeName.toLowerCase() &&
        !this.pageMouseDown &&
        this.options.lightBox &&
        this.options.lightboxCloseOnClick &&
  ...
  (FLIPBOOK.BookWebGL.prototype._getVector = function (t) {
    ...
    return new THREE.Vector3((o / e) * 2 - 1, (-s / i) * 2 + 1, 0.5);
  }),
  (FLIPBOOK.BookWebGL.prototype._touchmove = function (t) {
    t.touches.length > 1 || ((t = t.touches[0]), this._move(t));
  }),
  (FLIPBOOK.BookWebGL.prototype.move = function (t) {
    if (!(this.zoom <= 1)) {
      var e = 0,
        i = 0;
      switch (t) {
      ...
      (this.centerContainer.position.x +=
        (1e4 * e) / (this.cameraZ * this.zoom * this.zoom)),
        (this.centerContainer.position.y -=
          (1e4 * i) / (this.cameraZ * this.zoom * this.zoom)),
        this.updateHtmlLayerPosition();
    }
  }),
  (FLIPBOOK.BookWebGL.prototype._move = function (t) {
    ...
    var i = new THREE.Raycaster(
      ...
      o = t,
      s = 0.5 * (o.pageX - this.pointX),
      n = 0.5 * (o.pageY - this.pointY);
    if (((this.pointX = o.pageX), (this.pointY = o.pageY), !this.mouseDown))
      return (
        (this.onMouseMove = ""),
        void (
          ...
          ((this.tilt =
            ...
            (this.options.tiltMax2 - this.options.tiltMin2) *
              (1 - this.pointY / jQuery(this.canvas).height())),
          (this.pan =
            this.options.panMin2 +
            ((this.options.panMax2 - this.options.panMin2) * this.pointX) /
              jQuery(this.canvas).width()),
          this.updateCameraPosition())
        )
      );
    if (
      (i.length > 0
        ...
        : "" == this.onMouseMove && (this.onMouseMove = "rotate"),
      ...
      (0 == s && 0 == n) ||
        ((this.moved = !0),
        (this.centerContainer.position.x +=
          (1e4 * s) / (this.cameraZ * this.zoom * this.zoom)),
        (this.centerContainer.position.y -=
          (1e4 * n) / (this.cameraZ * this.zoom * this.zoom))),
        this.updateHtmlLayerPosition();
  ...
  (FLIPBOOK.BookWebGL.prototype._end = function (t) {
    (this.mouseDown = !1),
      void 0 !== t.changedTouches && (t = t.changedTouches[0]),
      (this.pointX = t.pageX),
      (this.pointY = t.pageY),
      (this.endPoint = t);
    ...
    if (i.length > 0 && this.pageMouseDown && !this.moved) {
      var o = i[0];
      this.clickedPage = o.object.parent;
    }
    (this.pageMouseDown = !1), (this.moved = !1);
  }),
  (FLIPBOOK.BookWebGL.prototype.moveCamera = function (t, e) {}),
...
!(function (t) {
  (t.Constants = {
    ...
    (t.ModConstant = { LEFT: -1, RIGHT: 1, NONE: 0, X: 1, Y: 2, Z: 4 });
})(MOD3),
  (function (t) {
    var e = t.Constants;
    (t.XMath = {}),
      (t.XMath.normalize = function (e, i, o) {
        return i - e == 0 ? 1 : t.XMath.trim(0, 1, (o - e) / i);
      }),
      (t.XMath.toRange = function (t, e, i) {
        return e - t == 0 ? 0 : t + (e - t) * i;
      }),
      (t.XMath.inRange = function (t, e, i, o) {
        return void 0 === o && (o = !1), o ? i >= t && i <= e : i > t && i < e;
      }),
  ...
  (function (t) {
    (t.Phase = function (t) {
      (this.value = 0), void 0 !== t && (this.value = t);
    }),
      ...
      (t.Phase.prototype.getNormValue = function () {
        return 0.5 * (this.getPhasedValue() + 1);
      });
  })(MOD3),
  (function (t) {
  ...
  (function (t) {
    (t.Matrix = function (t, e, i, o) {
      ...
      (t.Matrix.prototype.rotate = function (t) {
        ...
        t = Math.sin(t);
        return (
          (this.m11 = e), (this.m12 = -t), (this.m21 = t), (this.m22 = e), this
        );
      }),
      ...
      (t.Matrix.prototype.transformPoint = function (e) {
        return new t.Point(
          this.m11 * e.x + this.m12 * e.y,
          this.m21 * e.x + this.m22 * e.y
        );
      });
  })(MOD3),
  (function (t) {
    (t.Vector3 = function (t, e, i) {
      ...
      (t.Vector3.prototype.divide = function (e) {
        return (e = 1 / e), new t.Vector3(this.x * e, this.y * e, this.z * e);
      }),
      (t.Vector3.prototype.normalize = function () {
        var t = this.x,
          ...
          i = this.z;
        (t = t * t + e * e + i * i) > 0 &&
          ((t = 1 / Math.sqrt(t)), (this.x *= t), (this.y *= t), (this.z *= t));
      }),
      ...
      (t.Vector3.prototype.cross = function (e, i) {
        var o = e.x,
          ...
          h = i.y,
          a = i.z;
        return new t.Vector3(s * a - n * h, n * r - o * a, o * h - s * r);
      }),
    ...
    (t.Matrix4 = function (t, e, i, o, s, n, r, h, a, p, c, l, d, u, f, g) {
      ...
      (t.Matrix4.prototype.calculateMultiply = function (t, e) {
        var i = t.n11,
          ...
          b = t.n34,
          w = e.n34;
        (this.n11 = i * o + a * n + f * h),
          (this.n12 = i * p + a * l + f * u),
          (this.n13 = i * g + a * y + f * M),
          (this.n14 = i * P + a * O + f * w + v),
          (this.n21 = s * o + c * n + m * h),
          (this.n22 = s * p + c * l + m * u),
          (this.n23 = s * g + c * y + m * M),
          (this.n24 = s * P + c * O + m * w + L),
          (this.n31 = r * o + d * n + x * h),
          (this.n32 = r * p + d * l + x * u),
          (this.n33 = r * g + d * y + x * M),
          (this.n34 = r * P + d * O + x * w + b);
      }),
      ...
      (t.Matrix4.prototype.multiplyVector = function (t, e) {
        var i = e.x,
          o = e.y,
          s = e.z;
        (e.x = i * t.n11 + o * t.n12 + s * t.n13 + t.n14),
          (e.y = i * t.n21 + o * t.n22 + s * t.n23 + t.n24),
          (e.z = i * t.n31 + o * t.n32 + s * t.n33 + t.n34);
      });
  })(MOD3),
  (function (t) {
  ...
  (function (t) {
    (t.MeshProxy = function () {
      ...
      (t.MeshProxy.prototype.analyzeGeometry = function () {
        ...
        for (
          i = r - n,
            ...
            g = g(i, g(o, depth)),
            u == i && g == o
              ? ((this.minAxis = t.ModConstant.Y),
                (this.midAxis = t.ModConstant.Z),
                (this.maxAxis = t.ModConstant.X))
              : u == i && g == depth
              ? ((this.minAxis = t.ModConstant.Z),
                (this.midAxis = t.ModConstant.Y),
                (this.maxAxis = t.ModConstant.X))
              : u == o && g == i
              ? ((this.minAxis = t.ModConstant.X),
                (this.midAxis = t.ModConstant.Z),
                (this.maxAxis = t.ModConstant.Y))
              : u == o && g == depth
              ? ((this.minAxis = t.ModConstant.Z),
      ...
      (t.MeshProxy.prototype.resetGeometry = function () {
        for (var t = this.getVertices(), e = t.length; --e >= 0; ) t[e].reset();
      }),
  ...
  (function (t) {
    (t.Pivot = function (e, i, o) {
      this.pivot = new t.Vector3(e, i, o);
    }),
      (t.Pivot.prototype = new t.Modifier()),
      (t.Pivot.prototype.constructor = t.Pivot),
      (t.Pivot.prototype.setMeshCenter = function () {
        var e = this.mod;
      ...
      (t.Pivot.prototype.apply = function () {
        for (
          var t, e, i = this.mod.getVertices(), o = i.length, s = this.pivot;
          --o >= 0;

        )
          (e = (t = i[o]).getVector().clone()), t.setVector(e.add(s));
        this.mod.updateMeshPosition(s.clone().negate());
      });
  })(MOD3),
  (function (t) {
    (t.Bend = function (e, i, o) {
        ...
        if (0 != this.force)
          for (
            var e,
              ...
              f = this.m2,
              g = p + h * a,
              m = h / Math.PI / this.force,
              y = t.Constants.doublePI * (h / (m * t.Constants.doublePI)),
              x = 1 / h,
              M = t.Constants.halfPI,
              v = Math.sin,
              P = Math.cos;
            --r >= 0;
            ...
            (e = (h = n[r]).getValue(c)),
              (i = h.getValue(d)),
              (o = h.getValue(l)),
              (e = (i = u.transformPoint(new t.Point(e, i))).x),
              (i = i.y),
              (s = (e - p) * x),
              (this.constraint == t.ModConstant.LEFT && s <= a) ||
                (this.constraint == t.ModConstant.RIGHT && s >= a) ||
                ((e = v((s = M - y * a + y * s)) * (m + o)),
                (s = P(s) * (m + o)),
                (o = e - m),
                (e = g - s)),
  ...
  (function (t) {
    (t.Bloat = function () {
      (this.center = t.Vector3.ZERO()),
        (this.radius = 0),
        (this.a = 0.01),
        (this.u = t.Vector3.ZERO());
    }),
      (t.Bloat.prototype = new t.Modifier()),
      (t.Bloat.prototype.constructor = t.Bloat),
      (t.Bloat.prototype.setRadius = function (t) {
      ...
      (t.Bloat.prototype.apply = function () {
        for (
          ...
          (t = i[o]),
            ...
            (this.u.y = t.getY() - s.y),
            (this.u.z = t.getZ() - s.z),
            (e = this.u.getMagnitude()),
            this.u.setMagnitude(e + n * Math.exp(-e * r)),
            t.setX(this.u.x + s.x),
            t.setY(this.u.y + s.y),
            t.setZ(this.u.z + s.z);
      });
  ...
  (function (t) {
    (t.Twist = function (e) {
      (this.vector = new t.Vector3(0, 1, 0)),
        (this.angle = e),
        (this.center = t.Vector3.ZERO());
    }),
      (t.Twist.prototype = new t.Modifier()),
      (t.Twist.prototype.constructor = t.Twist),
      (t.Twist.prototype.apply = function () {
        this.vector.normalize();
        var e,
          i = (h = this.mod).getVertices(),
          o = i.length,
          s = this.vector,
          n = this.angle,
          r = this.center,
          h =
            ...
            n;
        for (r = -t.Vector3.dot(s, r); --o >= 0; )
          (e = (n = i[o]).getX() * s.x + n.getY() * s.y + n.getZ() * s.z + r),
            this.twistPoint(n, e * h);
      }),
      (t.Twist.prototype.twistPoint = function (e, i) {
        var o = new t.Matrix4().translationMatrix(e.getX(), e.getY(), e.getZ());
        o = new t.Matrix4().multiply(
          new t.Matrix4().rotationMatrix(
            this.vector.x,
            this.vector.y,
            this.vector.z,
            i
        ...
        e.setX(o.n14), e.setY(o.n24), e.setZ(o.n34);
      });
  })(MOD3),
  (function (t) {
    (t.Skew = function (e) {
      (this.force = 0),
        (this.skewAxis = null),
        void 0 !== e && (this.force = e),
        (this.offset = 0.5),
        (this.constraint = t.ModConstant.NONE),
        (this.falloff = this.power = 1),
        (this.swapAxes = this.oneSide = this.inverseFalloff = !1);
    }),
      (t.Skew.prototype = new t.Modifier()),
      (t.Skew.prototype.constructor = t.Skew),
      (t.Skew.prototype.setModifiable = function (e) {
        t.Modifier.prototype.setModifiable.call(this, e),
          (this.skewAxis = this.skewAxis || this.mod.maxAxis);
      }),
      (t.Skew.prototype.apply = function () {
        for (
          var e,
            i,
            o,
            s = this.mod.getVertices(),
            n = s.length,
            r = this.constraint,
            h = this.skewAxis,
            a = this.offset,
            p = this.oneSide,
            c = this.inverseFalloff,
            l = this.falloff,
            d = 1 - l,
            u = this.power,
            f = this.force,
            g = this.getDisplaceAxis();
          --n >= 0;

        )
          (e = s[n]),
            !(r == t.ModConstant.LEFT && e.getRatio(h) <= a) &&
              !(r == t.ModConstant.RIGHT && e.getRatio(h) > a) &&
              ((i = e.getRatio(h) - a),
              p && (i = Math.abs(i)),
              (o = e.getRatio(g)),
              c && (o = 1 - o),
              (o = l + o * d),
              (i = Math.pow(Math.abs(i), u) * t.XMath.sign(i, 1)),
              (i = e.getValue(g) + f * i * o),
              e.setValue(g, i));
      }),
      (t.Skew.prototype.getDisplaceAxis = function () {
        switch (this.skewAxis) {
          case t.ModConstant.X:
            return this.swapAxes ? t.ModConstant.Z : t.ModConstant.Y;
          case t.ModConstant.Y:
            return this.swapAxes ? t.ModConstant.Z : t.ModConstant.X;
          case t.ModConstant.Z:
            return this.swapAxes ? t.ModConstant.Y : t.ModConstant.X;
          default:
            return 0;
        }
      });
  ...
  (function (t) {
    (t.Taper = function (e) {
      (this.power = this.force = null),
        (this.start = 0),
        (this.end = 1),
        (this.vector = new t.Vector3(1, 0, 1)),
        (this.vector2 = new t.Vector3(0, 1, 0)),
        void 0 !== e && (this.force = e),
        (this.power = 1);
    }),
      (t.Taper.prototype = new t.Modifier()),
      (t.Taper.prototype.constructor = t.Taper),
      (t.Taper.prototype.setFalloff = function (t, e) {
        (this.start = 0),
          (this.end = 1),
          void 0 !== t && (this.start = t),
          void 0 !== e && (this.end = e);
      }),
      (t.Taper.prototype.apply = function () {
        for (
          var e,
            i,
            o,
          ...
          (i = (e = s[n]).getRatioVector().multiply(h)),
            (i = a * Math.pow(i.getMagnitude(), p)),
            (i = new t.Matrix4().scaleMatrix(
              1 + i * r.x,
              1 + i * r.y,
              1 + i * r.z
            )),
            (o = e.getVector()),
            new t.Matrix4().multiplyVector(i, o),
            e.setVector(o);
      });
  })(MOD3),
  (function (t) {
    (t.Wheel = function () {
      (this.radius = this.roll = this.turn = this.speed = null),
        (this.steerVector = new t.Vector3(0, 1, 0)),
        (this.rollVector = new t.Vector3(0, 0, 1)),
        (this.roll = this.turn = this.speed = 0);
    }),
      (t.Wheel.prototype = new t.Modifier()),
      (t.Wheel.prototype.constructor = t.Wheel),
      (t.Wheel.prototype.setModifiable = function (e) {
        t.Modifier.prototype.setModifiable.call(this, e),
          (this.radius = 0.5 * this.mod.width);
      }),
      (t.Wheel.prototype.apply = function () {
        ...
        for (
          0 != n
            ? ((e = new t.Matrix4().rotationMatrix(s.x, s.y, s.z, n)),
              (s = r.clone()),
              new t.Matrix4().multiplyVector(e, s),
              (h = new t.Matrix4().rotationMatrix(s.x, s.y, s.z, h)))
            : (h = new t.Matrix4().rotationMatrix(r.x, r.y, r.z, h));
          --o >= 0;

        )
          (r = (s = i[o]).getVector().clone()),
            0 != n && new t.Matrix4().multiplyVector(e, r),
            new t.Matrix4().multiplyVector(h, r),
            s.setX(r.x),
            s.setY(r.y),
            s.setZ(r.z);
      }),
      (t.Wheel.prototype.getStep = function () {
        return this.radius * this.speed * t.Constants.invPI;
      }),
      (t.Wheel.prototype.getPerimeter = function () {
        return this.radius * t.Constants.doublePI;
      });
  })(MOD3),
  (function (t) {
    (t.Break = function (e, i) {
      (this.bv = new t.Vector3(0, 1, 0)),
        (this.angle = this.offset = 0),
        void 0 !== e && (this.offset = e),
        void 0 !== i && (this.angle = i),
        (this.range = new t.Range(0, 1));
    }),
      (t.Break.prototype = new t.Modifier()),
      (t.Break.prototype.constructor = t.Break),
      (t.Break.prototype.apply = function () {
        var e,
          i,
          o,
          s = (o = this.mod).getVertices(),
          n = s.length,
          r = this.range,
          h = this.angle,
          a = this.bv;
        for (
          e = (o = new t.Vector3(
            0,
            0,
            -(o.minZ + o.depth * this.offset)
          )).negate(),
            i = new t.Matrix4().rotationMatrix(a.x, a.y, a.z, h);
          --n >= 0;

        )
          (a = (a = (h = s[n]).getVector()).add(o)).z >= 0 &&
            r.isIn(h.ratioY) &&
            new t.Matrix4().multiplyVector(i, a),
            (a = a.add(e)),
            h.setX(a.x),
            h.setY(a.y),
            h.setZ(a.z);
  ...
  (function (t) {
    (t.Noise = function (e) {
      (this.force = 0),
        (this.axc = t.ModConstant.NONE),
        (this.end = this.start = 0),
        void 0 !== e && (this.force = e);
    }),
      (t.Noise.prototype = new t.Modifier()),
      (t.Noise.prototype.constructor = t.Noise),
      (t.Noise.prototype.constraintAxes = function (t) {
        this.axc = t;
      }),
      (t.Noise.prototype.setFalloff = function (t, e) {
        (this.start = 0),
          (this.end = 1),
          void 0 !== t && (this.start = t),
          void 0 !== e && (this.end = e);
      }),
      (t.Noise.prototype.apply = function () {
        for (
          var t,
            e,
            i,
          ...
          (t = h[a]),
            (e = l() * p - c),
            (i = t.getRatio(o.maxAxis)),
            n < r
              ? (i < n && (i = 0), i > r && (i = 1))
              : n > r
              ? ((i = 1 - i) > n && (i = 0), i < r && (i = 1))
              : (i = 1),
            1 & s || t.setX(t.getX() + e * i),
            (s >> 1) & 1 || t.setY(t.getY() + e * i),
            (s >> 2) & 1 || t.setZ(t.getZ() + e * i);
      });
  })(MOD3),
  (function (t) {
  ...
  (function (t) {
    (t.MeshThree = function () {}),
      ...
      (t.MeshThree.prototype.setMesh = function (e) {
        ...
        var i,
          o = 0,
          s = this.mesh.geometry.vertices,
          n = s.length,
          r = this.mesh.geometry.faces,
          h = r.length;
        for (o = 0; o < n; )
          (i = new t.VertexThree(this.mesh)).setVertex(s[o]),
            this.vertices.push(i),
            (e[s[o]] = i),
            o++;
        for (o = 0; o < h; )
          (n = new t.FaceProxy()),
            r[o] instanceof THREE.Face3
              ? (n.addVertex(e[s[r[o].a]]),
                n.addVertex(e[s[r[o].b]]),
                n.addVertex(e[s[r[o].c]]))
              : r[o] instanceof THREE.Face4 &&
                (n.addVertex(e[s[r[o].a]]),
                n.addVertex(e[s[r[o].b]]),
                n.addVertex(e[s[r[o].c]]),
                n.addVertex(e[s[r[o].d]])),
            this.faces.push(n),
            o++;
        delete lookup;
      }),
  ...
  (function (t) {
    (t.LibraryPre3D = function () {
      (this.id = "pre3d.js"),
        (this.meshClass = t.MeshPre3D),
        (this.vertexClass = t.VertexPre3D);
    }),
      (t.LibraryThree.prototype = new t.Library3d()),
      (t.LibraryThree.prototype.constructor = t.LibraryPre3D);
  })(MOD3),
  (function (t) {
    (t.VertexPre3D = function () {}),
      (t.VertexPre3D.prototype = new t.VertexProxy()),
      (t.VertexPre3D.prototype.setVertex = function (t) {
        (this.vertex = t),
          (this.originalX = t.x),
          (this.originalY = t.y),
          (this.originalZ = t.z);
  ...
  (function (t) {
    (t.MeshPre3D = function () {}),
      (t.MeshPre3D.prototype = new t.MeshProxy()),
      (t.MeshPre3D.prototype.setMesh = function (e) {
        t.MeshProxy.prototype.setMesh.call(this, e);
        e = [];
        for (
          var i = this.mesh.vertices,
            o = this.mesh.quads,
            s = i.length,
            n = o.length,
            r = 0;
          ...
          var h = new t.VertexPre3D();
          h.setVertex(i[r]), this.vertices.push(h), (e[i[r]] = h);
        }
        for (r = 0; r < n; r++)
          (s = new t.FaceProxy()),
            o[r] instanceof Pre3d.QuadFace &&
              (s.addVertex(e[i[o[r].i0]]),
              s.addVertex(e[i[o[r].i1]]),
              s.addVertex(e[i[o[r].i2]]),
              null != o[r].i3 && s.addVertex(e[i[o[r].i3]])),
            this.faces.push(s);
        delete lookup;
      }),
      (t.MeshPre3D.prototype.updateMeshPosition = function () {});
  })(MOD3),
  (function (t) {
    (t.LibraryJ3D = function () {
      (this.id = "J3D"),
        (this.meshClass = t.MeshJ3D),
        (this.vertexClass = t.VertexJ3D);
    }),
      (t.LibraryJ3D.prototype = new t.Library3d()),
      (t.LibraryJ3D.prototype.constructor = t.LibraryJ3D);
  })(MOD3),
  (function (t) {
    (t.VertexJ3D = function (t) {
      this.geometry = t;
    }),
      (t.VertexJ3D.prototype = new t.VertexProxy()),
      (t.VertexJ3D.prototype.setVertex = function (t) {
        this.vertex = t;
        var e = this.geometry;
        (this.originalX = e.vertexPositionBuffer.data[t]),
          (this.originalY = e.vertexPositionBuffer.data[t + 1]),
          (this.originalZ = e.vertexPositionBuffer.data[t + 2]);
      }),
      ...
      (t.VertexJ3D.prototype.setX = function (t) {
        var e = this.geometry;
        (e.vertexPositionBuffer.data[this.vertex] = t),
          e.replaceArray(e.vertexPositionBuffer, e.vertexPositionBuffer.data);
      }),
      (t.VertexJ3D.prototype.setY = function (t) {
        var e = this.geometry;
        (e.vertexPositionBuffer.data[this.vertex + 1] = t),
          e.replaceArray(e.vertexPositionBuffer, e.vertexPositionBuffer.data);
      }),
      (t.VertexJ3D.prototype.setZ = function (t) {
        var e = this.geometry;
        (e.vertexPositionBuffer.data[this.vertex + 2] = t),
          e.replaceArray(e.vertexPositionBuffer, e.vertexPositionBuffer.data);
      });
  })(MOD3),
  (function (t) {
    (t.MeshJ3D = function () {}),
      (t.MeshJ3D.prototype = new t.MeshProxy()),
      (t.MeshJ3D.prototype.setMesh = function (e) {
        t.MeshProxy.prototype.setMesh.call(this, e);
        var i,
          o = 0,
          s = e.geometry.vertexPositionBuffer.data.length,
          n = e.geometry.vertexPositionBuffer.itemSize;
        for (o = 0; o < s; )
          (i = new t.VertexJ3D(e.geometry)).setVertex(o),
            this.vertices.push(i),
            (o += n);
        this.faces = null;
      }),
      (t.MeshJ3D.prototype.updateMeshPosition = function (t) {
        var e = this.mesh;
        (e.position.x += t.x), (e.position.y += t.y), (e.position.z += t.z);
      });
  })(MOD3),
  (function (t) {
    (t.LibraryCopperlicht = function () {
      (this.id = "Copperlicht"),
        (this.meshClass = t.MeshCopperlicht),
        (this.vertexClass = t.VertexCopperlicht);
    }),
      (t.LibraryCopperlicht.prototype = new t.Library3d()),
      (t.LibraryCopperlicht.prototype.constructor = t.LibraryCopperlicht);
  })(MOD3),
  (function (t) {
    (t.VertexCopperlicht = function (t, e) {
      (this.node = t), (this.buffer = e);
    }),
      (t.VertexCopperlicht.prototype = new t.VertexProxy()),
      (t.VertexCopperlicht.prototype.setVertex = function (t) {
        (this.vertex = t),
  ...
  (function (t) {
    (t.MeshCopperlicht = function () {}),
      (t.MeshCopperlicht.prototype = new t.MeshProxy()),
      (t.MeshCopperlicht.prototype.setMesh = function (e) {
        t.MeshProxy.prototype.setMesh.call(this, e);
        e = this.mesh.getMesh().GetMeshBuffers();
        for (var i = [], o = 0; o < e.length; o++)
          for (var s = (i = e[o].Vertices).length, n = 0; n < s; n++) {
            var r = new t.VertexCopperlicht(this.mesh, e[o]);
            r.setVertex(i[n]), this.vertices.push(r);
          }
        (this.faces = null), delete lookup;
      }),
      (t.MeshCopperlicht.prototype.updateMeshPosition = function (t) {
        (this.mesh.Pos.X += t.x),
          (this.mesh.Pos.Y += t.y),
          (this.mesh.Pos.Z += t.z);
      });
  ...
  (function (t) {
    if (
      ...
      var e =
        t.performance.timing && t.performance.timing.navigationStart
  ...
  (FLIPBOOK.TWEEN.Tween = function (t) {
    var e = t,
      ...
      c = 0,
      l = null,
      d = FLIPBOOK.TWEEN.Easing.Linear.None,
      u = FLIPBOOK.TWEEN.Interpolation.Linear,
      f = [],
      g = null,
      m = !1,
      y = null,
      x = null,
      M = null;
    for (var v in t) i[v] = parseFloat(t[v], 10);
    (this.to = function (t, e) {
      return void 0 !== e && (n = e), (o = t), this;
    }),
      (this.start = function (t) {
        for (var n in (FLIPBOOK.TWEEN.add(this),
        (a = !0),
        (m = !1),
        (l = void 0 !== t ? t : window.performance.now()),
        (l += c),
        o)) {
      ...
      (this.stopChainedTweens = function () {
        for (var t = 0, e = f.length; t < e; t++) f[t].stop();
      }),
      ...
      (this.update = function (t) {
        ...
        for (a in o) {
          ...
          L instanceof Array
            ? (e[a] = u(L, v))
            : ("string" == typeof L && (L = P + parseFloat(L, 10)),
              "number" == typeof L && (e[a] = P + (L - P) * v));
        }
        if ((null !== y && y.call(e, v), 1 == M)) {
          if (r > 0) {
            for (a in (isFinite(r) && r--, s)) {
              if (
                ("string" == typeof o[a] &&
                  (s[a] = s[a] + parseFloat(o[a], 10)),
                h)
              ) {
                var O = s[a];
                (s[a] = o[a]), (o[a] = O);
            ...
            return h && (p = !p), (l = t + c), !0;
          }
          null !== x && x.call(e);
          for (var b = 0, w = f.length; b < w; b++) f[b].start(t);
          return !1;
        }
        return !0;
      });
  ...
  (FLIPBOOK.TWEEN.Easing = {
    ...
    Bounce: {
      ...
      InOut: function (t) {
        return t < 0.5
          ? 0.5 * FLIPBOOK.TWEEN.Easing.Bounce.In(2 * t)
          : 0.5 * FLIPBOOK.TWEEN.Easing.Bounce.Out(2 * t - 1) + 0.5;
      },
    },
  }),
  (FLIPBOOK.TWEEN.Interpolation = {
    ...
    CatmullRom: function (t, e) {
      ...
      return t[0] === t[i]
        ? (e < 0 && (s = Math.floor((o = i * (1 + e)))),
          n(t[(s - 1 + i) % i], t[s], t[(s + 1) % i], t[(s + 2) % i], o - s))
        : e < 0
        ? t[0] - (n(t[0], t[0], t[1], t[1], -o) - t[0])
        : e > 1
        ? t[i] - (n(t[i], t[i], t[i - 1], t[i - 1], o - i) - t[i])
        : n(
            t[s ? s - 1 : 0],
            t[s],
            t[i < s + 1 ? i : s + 1],
  ...
  (FLIPBOOK.CSS3DSprite.prototype = Object.create(
    FLIPBOOK.CSS3DObject.prototype
  )),
  ...
  (FLIPBOOK.CSS3DRenderer = function () {
    ...
    function d(t, e) {
      var s = t.elements,
        n =
          ...
          ")";
      return p
        ? "translate(-50%,-50%)translate(" + i + "px," + o + "px)" + e + n
        : "translate(-50%,-50%)" + n;
    }
    (this.getSize = function () {
      return { width: t, height: e };
    }),
      (this.setSize = function (s, n) {
        (i = (t = s) / 2),
          (o = (e = n) / 2),
          (h.style.width = s + "px"),
          (h.style.height = n + "px"),
    ...
    function m(t) {
      for (
        ...
        e[o].element.style.zIndex = i - o;
    }
    this.render = function (t, e) {
      var u = e.projectionMatrix.elements[5] * o;
      if (
        (r.camera.fov !== u &&
          (e.isPerspectiveCamera
            ? ((h.style.WebkitPerspective = u + "px"),
              (h.style.perspective = u + "px"))
            : ((h.style.WebkitPerspective = ""), (h.style.perspective = "")),
          (r.camera.fov = u)),
        !0 === t.autoUpdate && t.updateMatrixWorld(),
        null === e.parent && e.updateMatrixWorld(),
        e.isOrthographicCamera)
      )
        var f = -(e.right + e.left) / 2,
          y = (e.top + e.bottom) / 2;
      var x = e.isOrthographicCamera
          ? "scale(" +
            u +
            ")translate(" +
            c(f) +
          ...
          : "translateZ(" + u + "px)" + l(e.matrixWorldInverse),
        M = x + "translate(" + i + "px," + o + "px)";
      r.camera.style === M ||
        p ||
        ((a.style.WebkitTransform = M),
        (a.style.transform = M),
        (r.camera.style = M)),
        (function t(e, i, o, h) {
          if (e instanceof FLIPBOOK.CSS3DObject) {
            var c;
            e.onBeforeRender(s, i, o),
              e instanceof FLIPBOOK.CSS3DSprite
                ? (n.copy(o.matrixWorldInverse),
                  n.transpose(),
            ...
            var l = e.element,
              u = r.objects.get(e);
            if (void 0 === u || u.style !== c) {
              (l.style.WebkitTransform = c), (l.style.transform = c);
              var f = { style: c };
              p && (f.distanceToCameraSquared = g(o, e)), r.objects.set(e, f);
            }
            l.parentNode !== a && a.appendChild(l), e.onAfterRender(s, i, o);
          }
          for (var m = 0, y = e.children.length; m < y; m++)
            t(e.children[m], i, o, h);
        })(t, t, e, x),
        p && m(t);
    };
  });
